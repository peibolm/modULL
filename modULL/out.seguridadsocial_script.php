...
/**
 *      \file       modULL/seguridadsocial_script.php
 *		\ingroup    modULL
...
// Examples for manipulating class seguridadsocial_class
require_once(DOL_DOCUMENT_ROOT."/../modULL/seguridadsocial.class.php");
$myobject=new Seguridadsocial($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."seguridadsocial";
